            ...
            CGPROGRAM
                ...
                float4 frag(v2f i) : COLOR
                {
                    ...
                    float3 viewdir = normalize(_ViewPos - i.worldvertpos);
               		...
               		float lightLevel = dot(normalize(_SunPos), i.normal);
                	...
                	color.rgb = lerp(color.rgb, atmo.rgb, atmo.a);
                   	...
                   	//now add specularity
                   	float3 light = normalize(_SunPos);				    
            ...
            CGPROGRAM
               ...
               // #pragma fragmentoption ARB_precision_hint_fastest
                ...
                float4 frag(v2f i) : COLOR
                {
                   ...
                   // float3 viewdir = normalize(i.pos -  _ViewPos);
                  
                    float4 color = _AtmoColor;
                    color.a = pow(saturate(dot(viewdir, i.normal)), _Falloff);
                    color.a *= _Transparency*_Color*dot(normalize(_SunPos), i.normal);
                    return color;
                }
            ENDCG
        }
