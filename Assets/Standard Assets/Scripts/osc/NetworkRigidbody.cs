...
public class NetworkRigidbody : MonoBehaviour {
	...
	internal double timestamp;
		...
		internal bool parented; //are these world or local coords
	}
	 ...
	 void OnSerializeNetworkView(BitStream stream, NetworkMessageInfo info) {
		...
		if (stream.isWriting)  {
			...
			if(transform.parent != null){			//if we are parented to something then send over local position
